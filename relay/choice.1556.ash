...
4: { "id":"4", "name":"second-hand hot plate", "location":"Any zone with hiding place", "need1":"food", "effect1": "Items: random food from the drop pool", "need2":"", "effect2": ""},
5: { "id":"5", "name":"beer cooler", "location":"Any zone with hiding place", "need1":"booze", "effect1": "Items: random beer from drop pool", "need2":"", "effect2": ""},
...
10: { "id":"10", "name":"beer pong table", "location":"The Orcish Frat House", "need1":"exercise", "effect1": "Item: table tennis ball (11863)<br>Combat item, delevels monster by 25%", "need2":"booze ", "effect2": "Items: 2 random beers from drop pool (duplicates possible)"},
...
13: { "id":"13", "name":"sous vide laboratory", "location":"The Haunted Kitchen", "need1":"mental stimulation", "effect1": "Effect: Counter Intelligence (10 adv)<br>Maximum MP +30<br>+30% Meat from Monsters", "need2":"food", "effect2": "Item: random food from the drop pool"},
14: { "id":"14", "name":"programmable blender", "location":"Cobb's Knob Kitchens", "need1":"mental stimulation", "effect1": "Effect: Counter Intelligence (10 adv)<br>Maximum MP +30<br>+30% Meat from Monsters", "need2":"booze ", "effect2": "Item: random booze"},
...
16: { "id":"16", "name":"fruit-smashing robot", "location":"The Hippy Camp (Verge of War) (In Frat Boy Ensemble or Frat Warrior Fatigues)", "need1":"dumb entertainment", "effect1": "Effect: You Might Have Gotten Wet (10 adv)<br>Moxie +20<br>Ranged Damage +20<br>Damage Reduction: 10", "need2":"food", "effect2": "Item: 2 fruits from the drop pool (duplicates possible)"},
17: { "id":"17", "name":"ManCave™ sports bar set", "location":"A Barroom Brawl", "need1":"dumb entertainment", "effect1": "Item: bar dart (11870)<br>Combat item, damage a foe and increase booze drops", "need2":"booze", "effect2": "Item: random booze from the drop pool"},
...
19: { "id":"19", "name":"kegerator", "location":"The Orcish Frat House (Bombed Back to the Stone Age)", "need1":"food", "effect1": "Item: 2 random foods from the drop pool", "need2":"booze", "effect2": "Item: pint of Leprechaun Stout"},
20: { "id":"20", "name":"fine upholstered dining set", "location":"The Hidden Apartment Building", "need1":"food", "effect1": "Item: random food from the drop pool", "need2":"sleep", "effect2": "Sur La Table (20 advs)<br>Regenerate 5-10 MP per Adventure<br>Regenerate 5-10 HP per Adventure"},
21: { "id":"21", "name":"whiskeybed", "location":"The Castle in the Clouds in the Sky (Ground Floor)", "need1":"booze", "effect1": "Item: random booze from the drop pool", "need2":"sleep", "effect2": "Moist Night's Sleep<br>+50% Combat Initiative<br>So-So Hot Resistance (+2)<br>+10 Cold Damage"},
...
24: { "id":"24", "name":"ultimate retro game console", "location":"Megalo-City", "need1":"dumb entertainment", "effect1": "Item: phosphor traces (11865)<br>Staring at that old screen for so long left a bunch of CRT crud in the corners of your eyes.<br><br>Type: spleen item<br>Toxicity: 3<br>Selling Price: 100 Meat.<br><br>Create an afterimage of a foe", "need2":"", "effect2": ""},
25: { "id":"25", "name":"Omnipot", "location":"Cobb's Knob Laboratory ", "need1":"food", "effect1": "Item: random food from the drop pool", "need2":"", "effect2": ""},
26: { "id":"26", "name":"fully-stocked wet bar", "location":"The Purple Light District", "need1":"booze", "effect1": "Item: random booze from the drop pool", "need2":"", "effect2": ""},
...
string makeOption(FurnitureItem fi, LepRoom room) {
    ...
    string needs = "(" + allFurnitures[fi.id, "need1"];
    if (allFurnitures[fi.id, "need2"].length() > 0) {
        needs += ", " + allFurnitures[fi.id, "need2"];
    }
    needs += ")";
...
string makeComboBox(LepStuff lepData, int roomNo) {
    string result = "";
    result += "<select id=\"r" + to_string(roomNo) + "\" name=\"r" + to_string(roomNo) + "\">\n\r";
