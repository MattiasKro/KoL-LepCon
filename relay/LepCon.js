const __lepcon_effects = [
    ...
    ["food", "Items: decent random food from the drop pool", "", ""],
    ["booze", "Items: crappy/decent random beer from drop pool", "", ""],
    ...
    ["exercise", "Item: table tennis ball (11863)<br>Combat item, delevels monster by 25%", "booze", "Items: 2 random crappy-good beers from drop pool (duplicates possible)"],
    ...
    ["mental stimulation", "Effect: Counter Intelligence (10 adv)<br>Maximum MP +30<br>+30% Meat from Monsters", "food", "Item: random good food from the drop pool"],
    ["mental stimulation", "Effect: Counter Intelligence (10 adv)<br>Maximum MP +30<br>+30% Meat from Monsters", "booze", "Item: random good booze"],
    ...
    ["dumb entertainment", "Effect: You Might Have Gotten Wet (10 adv)<br>Moxie +20<br>Ranged Damage +20<br>Damage Reduction: 10", "food", "Item: 2 crappy/decent fruits from the drop pool (duplicates possible)"],
    ["dumb entertainment", "Item: bar dart (11870)<br>Combat item, damage a foe and increase booze drops", "booze", "Item: random good/awesome booze from the drop pool"],
    ...
    ["food", "Item: 2 random foods from the drop pool", "booze", "Item: pint of Leprechaun Stout (awesome booze)"],
    ["food", "Item: random decent food good from the drop pool", "sleep", "Sur La Table (20 advs)<br>Regenerate 5-10 MP per Adventure<br>Regenerate 5-10 HP per Adventure"],
    ["booze", "Item: random decent/good booze from the drop pool", "sleep", "Moist Night's Sleep<br>+50% Combat Initiative<br>So-So Hot Resistance (+2)<br>+10 Cold Damage"],
    ...
    ["food", "Item: random awesome food from the drop pool", "", ""],
    ["booze", "Item: random awesome booze from the drop pool", "", ""],
